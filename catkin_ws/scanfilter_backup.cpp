...
//      pose(1647);
//      a=1647;
//      for(int p = 0; p < cloud_save.points.size(); p++)
//      {
//          double dist = (pow(cloud_save.points[p].x-0.095,2)+pow(cloud_save.points[p].y,2)+pow(cloud_save.points[p].z-0.48,2));
//          if(dist<=9.0)
//          {
//              cloud_save2.push_back(cloud_save.points[p]);
//          }
//      }

//      std::stringstream ss0;
//      ss0 << "/home/wangzt/paper/"<< file << ".pcd";
//      pcl::io::savePCDFile(ss0.str(), cloud_save2);
//      std::cout<<ss0.str()<<std::endl;
//      cloud_save.clear();
//      cloud_save2.clear();
//      char c[50]={0};
//      sprintf(c, "pcl_viewer /home/wangzt/paper/%d.pcd", file);
//      system(c);
